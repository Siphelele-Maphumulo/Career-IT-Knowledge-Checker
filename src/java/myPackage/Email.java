...
public class Email {
    ...
    private static String getVerificationEmailHtml(String firstName, String code) {
        return "<!DOCTYPE html>" +
            ...
            "            <p>Careers IT Online System</p>" +
            "        </div>" +
            "        <div class='content'>" +
            "            <h2>Hello " + firstName + ",</h2>" +
            "            <p>Thank you for registering with Careers IT. To complete your registration, please use the verification code below:</p>"
            ...
            "        </div>" +
            "        <div class='footer'>" +
            "            <p><strong>Careers IT (CIT)</strong><br>" +
            "            BBBEE Level 1. Est 1994<br>" +
            "            Accredited with MICT, Services & LG Seta's<br>" +
            "            Ground Floor, 21 Centenary Building, Zenith Drive, Umhlanga Ridge<br>" +
            "            Tel 031 566 5588. Cell 0761881151 | Website: www.careersit.co.za</p>" +
