        ...
        <div class="question-card" id="addQuestionPanel">
            ...
            <div class="question-form">
                <form id="addQuestionForm" method="post" action="controller.jsp?page=questions&operation=addnew" enctype="multipart/form-data">
                    <div class="form-grid">
                        ...
                        <div class="form-group">
                            ...
                            <select id="questionTypeSelect" class="form-select" onchange="toggleOptions(); saveLastSelection()">
                                ...
                                <option value="PARAGRAPH" <%="PARAGRAPH".equals(lastQuestionType) ? "selected" : ""%>>Paragraph/Short Answer</option>
                            </select>
                    ...
                    <div id="paragraphOptions" style="display:none;">
                        <div class="form-group">
                            <label class="form-label">
                                <i class="fas fa-align-left" style="color: var(--accent-blue);"></i>
                                Expected Answer Length (Optional)
                            </label>
                            <div class="form-grid">
                                <div class="form-group">
                                    <label class="form-label" style="font-size: 12px;">Minimum Words</label>
                                    <input type="number" name="minWords" class="form-control" min="0" max="10000" placeholder="e.g., 50" value="">
                                    <small class="form-hint">Minimum number of words expected (optional)</small>
                                </div>
                                <div class="form-group">
                                    <label class="form-label" style="font-size: 12px;">Maximum Words</label>
                                    <input type="number" name="maxWords" class="form-control" min="0" max="10000" placeholder="e.g., 500" value="">
                                    <small class="form-hint">Maximum number of words allowed (optional)</small>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" name="paragraphMarks" class="form-control" min="1" max="100" value="5" required>
                            <small class="form-hint">This is the maximum marks that can be given when you manually mark this question</small>
                        </div>
                        
                        <div class="quick-add-indicator" style="background: #f0f7ff; color: #0c63e4; border-left-color: var(--accent-blue);">
                            <i class="fas fa-info-circle"></i>
                            <span><strong>Note:</strong> This question will NOT be auto-graded. You will manually mark student responses in the Results section.</span>
                        </div>
                    </div>
...
function toggleOptions() {
    ...
    if (qType === "TrueFalse") {
        ...
        if (paragraphOptions) paragraphOptions.style.display = "block";
        // Don't require options for paragraph questions
        if (opt1) opt1.required = false;
        if (opt2) opt2.required = false;
        if (opt3) opt3.required = false;
        if (opt4) opt4.required = false;
        ...
        // Hide correct answer container for paragraph questions
        const correctAnswerContainer = document.getElementById('correctAnswerContainer');
        if (correctAnswerContainer) correctAnswerContainer.style.display = "none";
