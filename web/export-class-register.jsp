...
<%
    ...
    try {
        ...
        if (currentUser != null) {
            currentUserFullName = (currentUser.getFirstName() != null ? currentUser.getFirstName().trim() : "") + " " + 
                               (currentUser.getLastName() != null ? currentUser.getLastName().trim() : "");
            if (currentUserFullName.trim().isEmpty()) {
                currentUserFullName = "User ID: " + userId;
            }
        }
    } catch (Exception e) {
        currentUserFullName = "User ID: " + session.getAttribute("userId");
    }
    ...
    <div class="report-container">
        ...
        <div class="report-header">
            <div class="institution-logo">
                ...
                <div class="institution-name">CAREERS IT (CIT)</div>
            </div>
...
<!--            <div class="filters-title">APPLIED FILTERS</div>-->
            ...
            <table class="data-table">
                ...
                <tr>
                    ...
                    <td class="text-center">
                        <a href="javascript:void(0)" class="clickable-student-id" onclick="showStudentDetails('<%= studentId %>', '<%= studentName %>', '<%= registrationDate %>', '<%= registrationTime %>', '<%= status %>', '<%= remarks %>')">
                            <%= studentId %>
                        </a>
                    </td>
    ...
    <script>
        ...
        function showStudentDetails(studentId, studentName, registrationDate, registrationTime, status, remarks) {
            ...
            detailsContent.innerHTML = `
                <div class="student-detail-row">
                    ...
                    <div class="student-detail-value"><strong>${studentId}</strong></div>
                </div>
                <div class="student-detail-row">
                ...
                <div class="student-detail-row">
                    <div class="student-detail-label">Registration Date:</div>
                    <div class="student-detail-value">${registrationDate}</div>
                </div>
                <div class="student-detail-row">
                    <div class="student-detail-label">Registration Time:</div>
                    <div class="student-detail-value">${registrationTime}</div>
                </div>
                <div class="student-detail-row">
                    <div class="student-detail-label">Status:</div>
                <div class="student-detail-value">
                    <span class="status-badge ${status eq 'Present' ? 'status-present' : 'status-absent'}">
                        ${status}
                    </span>
                </div>
                </div>
                <div class="student-detail-row">
                    <div class="student-detail-label">Remarks:</div>
                    <div class="student-detail-value">${remarks || 'No remarks'}</div>
                </div>
                <div class="student-detail-row">
                    <div class="student-detail-label">Action:</div>
                    <div class="student-detail-value">
                        <a href="adm-page.jsp?pgprt=8&student_id=${studentId}" class="btn btn-primary" style="font-size: 12px; padding: 8px 16px;">
